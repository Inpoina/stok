...
(async () => {
  ...
  // Lewati challenge Cloudflare
  await page.goto("https://ap-mc.klikindomaret.com", {
    waitUntil: "domcontentloaded",
    timeout: 60000
  });

  // Kirim permintaan refresh
      ...
      "https://ap-mc.klikindomaret.com/assets-klikidmauth/api/post/customer/api/webapp/authentication/refresh-token",
      {
        ...
        headers: {
          ...
          apps: JSON.stringify({
            ...
            device_family: "none",
            device_id: "klikindomaret-termux",
            os_name: "Linux",
            os_version: "Android"
          })
        },
  ...
  if (token) {
    ...
    console.log("✅ AccessToken disimpan ke token.txt");
  } else {
    console.error("❌ Gagal ambil token:", JSON.stringify(result, null, 2));
  }
})();
